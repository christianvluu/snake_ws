...
bool operator==(const ::snake_control::GetJointTrajectoryResponse_<ContainerAllocator1> & lhs, const ::snake_control::GetJointTrajectoryResponse_<ContainerAllocator2> & rhs)
{
